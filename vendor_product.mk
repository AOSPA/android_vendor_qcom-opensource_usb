...
ifneq ($(filter bengal monaco pitti,$(TARGET_BOARD_PLATFORM)),)
...
ifneq ($(filter bengal kona lahaina taro blair kalama pineapple sun parrot monaco tuna kera,$(TARGET_BOARD_PLATFORM)),)
